...
void AnalysisHWW::Loop(TString analysis, TString filename, float luminosity){
  ...
  for (Long64_t jentry=0; jentry<_nentries;jentry++) {
    ...
    FillLevelHistograms(HWW_05_bveto,pass);
	 ...
	 //cut on the dphill in MET
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 12 && ptll > 30 && mth > 60 && metPfType1 > metcut && _dphillmet>1.57);
    FillLevelHistograms(HWW_06_dphillMet,pass);

	 //cut on high mll
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 12 && ptll > 30 && mth > 60 && metPfType1 > metcut && _dphillmet>1.57 && mll<55);
    FillLevelHistograms(HWW_07_mllHigh,pass);
	
	 //cut on Dphill
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 12 && ptll > 30 && mth > 60 && metPfType1 > metcut && _dphillmet>1.57 && mll <55 && dphill<1.8);
    FillLevelHistograms(HWW_08_dphill,pass);
    ...
    FillLevelHistograms(HWW_09_mllHighNOdphiMET,pass);
	
	 //same cut on Dphill  but without the METdphill cut
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 12 && ptll > 30 && mth > 60 && metPfType1 > metcut && mll <55 && dphill<1.8);
    FillLevelHistograms(HWW_10_dphillNOdphiMET,pass);
	 //---------------------------------------------------------------------------------
	 //Control regions
	 //TOP
	 //0jets
	 pass = (pass_os && pass_pt && pass_zveto && mll > 55 && ptll > 30 && metPfType1 > metcut && _dphillmet>1.57 && dphill<1.8 && pass_btag);
    FillLevelHistograms(HWW_11_TopControl0Jet,pass);
	 //1jet
	 pass = (pass_os && pass_pt && pass_zveto && mll > 55 && ptll > 30 && mth > 60 && metPfType1 > metcut  && dphill<1.8 && pass_bveto && pass_btag);
    FillLevelHistograms(HWW_12_TopControl1Jet,pass);
	 //WW 
	 //0jets
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 80 && ptll > 30 && mth > 60 && metPfType1 > metcut && _dphillmet>1.57 && dphill>1.8);
    FillLevelHistograms(HWW_13_WWControl0Jet,pass);
    //1jet
	 pass = (pass_os && pass_pt && pass_zveto && pass_bveto && mll > 80 && ptll > 30 && mth > 60 && metPfType1 > metcut && _dphillmet>1.57);
    FillLevelHistograms(HWW_14_WWControl1Jet,pass);
	}
