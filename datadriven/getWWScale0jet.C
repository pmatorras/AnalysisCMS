...
void getWWScale0jet  (TString analysis = "HWW", TString Top_control_level = "09_WWControl0Jet/0jet", TString HWW_signal_level = "06_mllHighNOdphiMET/0jet", double lumi_fb = 35.9) {
