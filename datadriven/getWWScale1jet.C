...
void getWWScale1jet  (TString analysis = "HWW", TString Top_control_level = "10_WWControl1Jet/1jet", TString HWW_signal_level = "06_mllHighNOdphiMET/1jet", double lumi_fb = 35.9) {
